...
InfoBox.prototype.draw = function () {
    ...
    this.div_.style.left = (pixPosition.x - (jQuery(this.div_).width() / 2)) + "px";
    this.div_.style.top = (pixPosition.y - jQuery(this.div_).height() - this.offsetPaddingTop) + "px";
...
InfoBox.prototype.createElement = function () {
    ...
    if (!div) {
        ...
        closeImg.src = domain+"/sites/all/modules/DEVELOPER/HSSPageStatics/View/img/close.png";
